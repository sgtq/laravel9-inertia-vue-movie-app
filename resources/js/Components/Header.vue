                    ...
                    <a href="#"
                       class="flex items-center px-4 py-3 text-gray-600 hover:text-white hover:bg-indigo-600 -mx-2">
                        ...
                        <p class="text-sm mx-2">
                            ...
                            class="font-bold text-indigo-400" href="#">Upload Image</span> article . 2m
                        </p>
                    </a>
                    <a href="#"
                       class="flex items-center px-4 py-3 text-gray-600 hover:text-white hover:bg-indigo-600 -mx-2">
                    ...
                    <a href="#"
                       class="flex items-center px-4 py-3 text-gray-600 hover:text-white hover:bg-indigo-600 -mx-2">
                        ...
                        <p class="text-sm mx-2">
                            ...
                            class="font-bold text-indigo-400" href="#">Test with TDD</span> article . 1h
                        </p>
                    </a>
                    <a href="#"
                       class="flex items-center px-4 py-3 text-gray-600 hover:text-white hover:bg-indigo-600 -mx-2">
